...
export function RemarksTable() {
  ...
  const remarksUIProps = useMemo(() => {
    return {
      ...
      studentId: remarksUIContext.studentId,
  ...
  useEffect(() => {
    ...
    dispatch(
      actions.fetchRemarks(remarksUIProps.queryParams, remarksUIProps.studentId)
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [remarksUIProps.queryParams, dispatch, remarksUIProps.studentId]);
  const columns = [
    {
      dataField: "id",
      text: "ID",
